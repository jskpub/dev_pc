!(function () {
  ...
  (function () {
    ...
    for (
      var n = window, P = n.setTimeout, x = document, J = x.documentElement, L = x.head || x.getElementsByTagName('head')[0] || J, z = '', A = x.getElementsByTagName('script'), m = A.length;
      --m >= 0;
    ...
    for (var R = D.length, A = [], m = 0, z = N.length; m < z; ++m) A.push(encodeURIComponent(N[m]) + '.css');
    (function (e) {
      function j(m) {
        if (m !== w) {
      ...
      (function () {
        ...
        function t(a) {
          ...
          a.tripleQuotedStrings
            ? d.push(['str', /^(?:'''(?:[^'\\]|\\[\S\s]|''?(?=[^']))*(?:'''|$)|"""(?:[^"\\]|\\[\S\s]|""?(?=[^"]))*(?:"""|$)|'(?:[^'\\]|\\[\S\s])*(?:'|$)|"(?:[^"\\]|\\[\S\s])*(?:"|$))/, r, '\'"'])
            : a.multiLineStrings
            ? d.push(['str', /^(?:'(?:[^'\\]|\\[\S\s])*(?:'|$)|"(?:[^"\\]|\\[\S\s])*(?:"|$)|`(?:[^\\`]|\\[\S\s])*(?:`|$))/, r, '\'"`'])
            : d.push(['str', /^(?:'(?:[^\n\r'\\]|\\.)*(?:'|$)|"(?:[^\n\r"\\]|\\.)*(?:"|$))/, r, '"\'']);
          ...
          b &&
            (a.cStyleComments
              ? (b > 1
                ...
                h.push(['str', /^<(?:(?:(?:\.\.\/)*|\/?)(?:[\w-]+(?:\/[\w-]+)+)?[\w-]+\.h(?:h|pp|\+\+)?|[a-z]\w*)>/, r]))
              : d.push(['com', /^#[^\n\r]*/, r, '#']));
          ...
          h.push(
            ...
            ['pln', /^[$_a-z][\w$@]*/i, r],
            ['lit', /^(?:0x[\da-f]+|(?:\d(?:_\d+)*\d*(?:\.\d*)?|\.\d\+)(?:e[+-]?\d+)?)[a-z]*/i, r, '0123456789'],
            ['pln', /^\\[\S\s]?/, r],
            ['pun', RegExp(b), r]
          );
          return C(d, h);
            ...
            if (c == 1 && !j.test(a.className))
              ...
              if (i)
                (c = d.substring(0, i.index)),
                  (a.nodeValue = c),
                  (d = d.substring(i.index + i[0].length)) && a.parentNode.insertBefore(l.createTextNode(d), a.nextSibling),
                  e(a),
        ...
        i(t({ keywords: L, hashComments: !0, cStyleComments: !0, verbatimStrings: !0, types: Q }), ['cs']);
        ...
        i(t({ keywords: N, hashComments: !0, multiLineStrings: !0, regexLiterals: !0 }), ['rb', 'ruby']);
          ...
          prettyPrint:
            (e = e =
              function (a, d) {
                ...
                for (
                  var b = d || document.body, i = b.ownerDocument || document, b = [b.getElementsByTagName('pre'), b.getElementsByTagName('code'), b.getElementsByTagName('xmp')], j = [], m = 0;
                  m < b.length;
                  ++m
                )
